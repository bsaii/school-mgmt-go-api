...
const { authenticateToken, handle404Error, csrfProtection, checkApiAccess, validateServiceKey } = require("../middlewares");
const { studentsInternalRoutes } = require("../modules/students/students-internal-router.js");
...
router.use("/internal/students", validateServiceKey, studentsInternalRoutes);
